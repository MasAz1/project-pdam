...
$bgColorProject = match ($device->project) {
    ...
    default => '#112240'
                                                    ...
                                                    <div style="background-color: <?php echo e($bgColorProject); ?>" class="p-6 rounded-xl shadow-lg my-4">
                                                        <h1 class="text-2xl font-bold text-blue-400 mb-4">Monitoring Device: <?php echo e($device->name); ?></h1>
        ...
        $unit = '%';
                                            ...
                                            <div id="debugModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
                                                ...
                                                <div class="bg-[#0a192f] text-white p-6 rounded shadow-lg w-[90%] md:w-[600px] max-h-[80vh] overflow-y-auto">
                                                    ...
                                                    <pre
                                                        class="text-sm whitespace-pre-wrap break-words"><?php echo e($device->last_debug_info ?? 'Tidak ada info detail'); ?></pre>
